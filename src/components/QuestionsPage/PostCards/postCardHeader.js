...
export const PostCardHeader = props => {
    let createdAt = moment(props.postData.createdAt);
    ...
    return (
        <div className="postCardHeader">
            <p className="postCardHeader-Content">
                ...
                <span className="lite-text">{handleTime()}</span>
            </p>
            {/*<p className="postCardHeader-Content">{`${props.postData.userName.toUpperCase()} posted in ${props.postData.categoryName} ${handdleTime()}`}</p>*/}
        </div>
    )
};
