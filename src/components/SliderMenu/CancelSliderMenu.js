...
export const CloseSliderMenu = props => {

    function handleCloseSliderMenu() {
        props.dispatch(set_show_slider_menu(false));
        return;
    }

    if (props.sliderMenuVisibility) {
        return (
            <div className="Closed-Slider-Menu-Icon-Wrapper" onClick={handleCloseSliderMenu}>
                <svg className="SliderMenuCrossIcon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 64 64">
                    <path
